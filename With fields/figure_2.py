...
std_values       = [0,0.02,0.04,0.06,0.08,0.1]
...
for std in std_values:
    ...
    for i in range(5, 101):
        ...
        caminho     = f"/home/gubio/CODESPACE/Pinn-inverse-for-opem-quantum-system/With fields/data/parametro_withfields_N50_seed{i}_std{std}.csv"
        try:
            ...
            print(f"parametro_withfields_N50_seed{i}_std{std}.csv")
            continue
...
plt.errorbar(std_arr, erro_js_Nc, yerr=yerr_J, fmt='ks', capsize=8, label=r'$J_{médio}$', linewidth=2.2)
...
plt.errorbar(std_arr, erro_gamma_Nc, yerr=yerr_g, fmt='o', color='r', capsize=8, linewidth=2.2,label=r'$\gamma_{médio}$') 
